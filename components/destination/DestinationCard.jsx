  ...
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <Typography color="gray" className="mt-1 font-normal">
        Find out the perfect destination for your next trip with our AI
      </Typography>
        ...
        <div className="mb-4 flex flex-col gap-6">
          <div>
            ...
            <Input
              ...
              variant="text"
              placeholder="Ocean, Village View, Mountains"
              labelProps={{
          ...
          <div>
            ...
            />
            <p className="text-xs">
              Leave empty to search for options all over the world
            </p>
          </div>
          {/* things to have */}
          <div className="mt-3">
